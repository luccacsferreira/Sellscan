      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md glass-card bg-brand-card/90 overflow-hidden"
          >
            {/* Header / Tabs */}
            ...
            <div className="p-8">
              ...
              <div className="mt-8 flex flex-col items-center gap-6">
                <div className="w-full flex items-center gap-4">
                  ...
                  <span className="text-[10px] text-white/20 uppercase font-black tracking-widest">Social Login</span>
                  <div className="h-px bg-white/5 flex-grow" />
                </div>

                <button 
                  onClick={handleGoogleLogin}
                  className="w-full py-3.5 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all text-xs font-bold active:scale-[0.98]"
                >
