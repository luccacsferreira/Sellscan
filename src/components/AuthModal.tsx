            ...
            <div className="p-8">
              ...
              <div className="mt-8 flex flex-col items-center gap-6">
                ...
                <button 
                  ...
                  disabled={isLoading}
                  className={cn(
                    "w-full py-3.5 border rounded-xl flex items-center justify-center gap-3 transition-all text-xs font-bold active:scale-[0.98] group",
                ...
                >
                  ...
                  {isSupabaseConfigured ? 'Google Account' : 'Supabase Not Configured'}
                </button>
              </div>
            </div>
          </motion.div>
