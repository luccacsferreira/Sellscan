...
export const AI_MODELS: AIModelInfo[] = [
  ...
  { id: 'gpt-5-preview', name: 'GPT-5 Preview', provider: 'openai', costPerScan: 2.5, minPlan: 'entrepreneur' },
  { id: 'claude-3.5-sonnet', name: 'Claude 3.5 Sonnet', provider: 'anthropic', costPerScan: 0.6, minPlan: 'reseller' },
  { id: 'claude-3.5-opus', name: 'Claude 3.5 Opus', provider: 'anthropic', costPerScan: 1.5, minPlan: 'entrepreneur' },
];
...
export const DEFAULT_PIPELINES: Record<AIPlan, AIPipelineConfig> = {
  ...
  entrepreneur: {
    ...
    strategyModel: 'claude-3.5-sonnet',
  }
};
